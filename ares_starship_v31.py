...
class AresStarshipNTR:
    ...
    def calculate_aerospike_motor(self):
        ...
        # FIX 1: Densidade C-C = 1950 kg/m³, não 8190
        ...
        # FIX 2: Massa da chamber Inconel-718 calculada
    ...
    def calculate_starship_mass(self):
        ...
        # FIX 3: Usa chamber_mass calculado + pump massa real pra 88.7 kg/s
        pump_mass = 9200
    ...
    def generate_all_files(self):
        ...
        # FIX 4: BOM usa valores calculados, não hardcoded
        bom_items = [
            ...
            ["Structure", "LH2 Tank Al-Li (9m Diameter)", f"9mD x {self.tank_length:.1f}mH", int(self.total_propellant*0.10), 9500000, 8],
